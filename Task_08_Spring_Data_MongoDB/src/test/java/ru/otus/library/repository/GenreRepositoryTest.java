...
class GenreRepositoryTest {
    ...
    void getAll() {
        ...
        Page<GenreDto> page = genreRepository.findGenresByBookId(PageRequest.of(0, 5), book.getId());
        assertThat(page.getContent()).extracting(GenreDto::getName).contains(genre1.getName()).contains(genre2.getName());
    }
}