...
class CommentRepositoryTest {
   ...
   @Test
    ...
    void getAll() {
        ...
        Page<CommentDto> page = commentRepository.findCommentsByBookId(PageRequest.of(0, 5), book.getId());
        assertThat(page.getContent()).extracting(CommentDto::getComment).contains(comment1.getComment()).contains(comment2.getComment());
    }
}